...
class PerfilUsuarioController extends Controller
{
    public function index()
    {
        ...
        // Préstamos Activos (Libros que tiene en casa ahora mismo)
        ...
        // Reservas Próximas (Salas que ha pedido de hoy en adelante)
        ...
        // Comprobar si tiene alguna sanción activa hoy
