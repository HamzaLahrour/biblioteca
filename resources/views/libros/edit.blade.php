        ...
        <div class="card shadow-sm border-0" style="border-radius: 12px;">
            <div class="card-header bg-white border-bottom-0 pt-4 pb-2 px-4">
                <h4 class="mb-0" style="color: var(--secondary-dark); font-weight: 700;">
                    <i class="bi bi-pencil-square me-2" style="color: var(--primary);"></i>Editar Libro
                </h4>
                <p class="text-muted mt-1 mb-0" style="font-size: 0.9rem;">
                    Modifica los datos del libro <strong>{{ $libro->titulo }}</strong>.
                </p>
            </div>
                ...
                <form action="{{ route('libros.update', $libro->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number"
                            ...
                            value="{{ old('copias_totales', $libro->copias_totales) }}"
                            placeholder="Ej: 10"
                            style="font-size: 1rem; border-color: #e0e0e0;">
