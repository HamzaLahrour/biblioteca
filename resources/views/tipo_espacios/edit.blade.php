            ...
            <div class="card-header bg-white border-bottom-0 pt-4 pb-2 px-4 d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="mb-0" style="color: var(--secondary-dark); font-weight: 700;">
                        <i class="bi bi-pencil-square me-2" style="color: var(--primary);"></i>Editar Tipo de espacio
                    </h4>
                    <p class="text-muted mt-1 mb-0" style="font-size: 0.9rem;">
                        Modifica los datos de esta clasificación.
                    </p>
                </div>
                <span class="badge" style="background-color: var(--secondary-light); color: #fff;">ID: {{ substr($tipoEspacio->id, 0, 8) }}...</span>
            </div>
            
            <div class="card-body p-4">
                <form action="{{ route('tipos_espacios.update', $tipoEspacio) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('nombre', $tipoEspacio->nombre) }}" 
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="descripcion" 
                                  ...
                                  style="border-color: #e0e0e0;">{{ old('descripcion', $tipoEspacio->descripcion) }}</textarea>
                        @error('descripcion')
                            <div class="invalid-feedback fw-medium">{{ $message }}</div>
                        @enderror
                    </div>
